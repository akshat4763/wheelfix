...
const MechanicPage = () => {
  ...
  if (!isClient) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center gap-8">
        <Image src="/logo.svg" alt="WheelFix - Join as Mechanic Partner" width={160} height={160} className="w-40 h-40" />
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Structured Data for Mechanic Partnership Page */}
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "JobPosting",
            "title": "Mechanic Partner - Individual & Shop Owners",
            "description": "Join WheelFix as a mechanic partner. Flexible work hours, increased earnings, and access to verified customer requests across India.",
            "hiringOrganization": {
              "@type": "Organization",
              "name": "WheelFix",
              "sameAs": "https://www.wheelfix.in",
            ...
            "workHours": "Flexible",
            "jobBenefits": "Flexible schedule, Increased earnings, Verified customers, Secure payments",
            "qualifications": "Experience in vehicle repair and maintenance",
            "skills": "Auto repair, Vehicle maintenance, Customer service"
          })
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Join as Mechanic Partner",
            "description": "Mechanic partnership program with WheelFix",
              ...
              "itemListElement": [
                {
                  ...
                  "item": {
                    "@type": "Offer",
                    "name": "Earn More",
                    "description": "Increase your earnings with more job opportunities every day"
                  }
                },
                {
                  "@type": "ListItem",
                  ...
                  "item": {
                    ...
                    "description": "Work when you want, where you want, across your city"
                  }
                },
                {
                  "@type": "ListItem",
                  ...
                  "item": {
                    ...
                    "description": "Get access to pre-verified and secure customer requests"
                  }
                }
              ]
            }
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "Who can join WheelFix as a mechanic partner?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Both individual mechanics and auto repair shop owners can join WheelFix as partners. We welcome experienced professionals in vehicle repair and maintenance."
                }
              },
              {
                "@type": "Question",
                "name": "How much can I earn as a WheelFix mechanic partner?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Earnings depend on the number of jobs you complete. Partners have flexible schedules and can take on as many jobs as they want to increase their income."
                }
              },
              {
                "@type": "Question",
                "name": "Do I need to work full-time?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "No, WheelFix offers completely flexible working hours. You can work part-time or full-time based on your availability and preferences."
                }
              },
              {
                "@type": "Question",
                ...
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Payments are processed securely and directly to your registered bank account after job completion and customer confirmation."
                }
              }
            ]
          })
      ...
      <section className="px-6 py-20 max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button 
            ...
            aria-label="Apply now as mechanic partner"
          >
            Apply Now
          </Button>
          <Button 
            ...
            aria-label="View partnership benefits"
          >
            Why Join?
          </Button>
        </div>
      ...
      {/* Benefits Section */}
      <section className="px-6 py-16 max-w-7xl mx-auto" id="benefits" aria-labelledby="benefits-heading">
        <h2 id="benefits-heading" className="sr-only">Partnership Benefits</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Card className="bg-gray-50 border-0 rounded-3xl overflow-hidden">
            <CardContent className="p-8 flex flex-col items-start min-h-[400px]">
              <div className="w-32 h-32 bg-white rounded-2xl mb-auto flex items-center justify-center" aria-hidden="true">
          ...
          <Card className="bg-gray-50 border-0 rounded-3xl overflow-hidden">
            <CardContent className="p-8 flex flex-col items-start min-h-[400px]">
              <div className="w-32 h-32 bg-white rounded-full mb-auto flex items-center justify-center" aria-hidden="true">
      ...
      <section id="application-form" className="px-6 py-20 max-w-2xl mx-auto">
        ...
        <form className="space-y-6" aria-label="Mechanic partner application form">
          {/* Name Field */}
          <div>
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute left-6 top-1/2 -translate-y-1/2 text-gray-600 font-medium" aria-label="Country code">
                +91
              </span>
              <Input
                id="phone"
          ...
          {formData.mechanicType === "individual" && (
            <div className="pt-4 border-t border-gray-200">
              <label htmlFor="workingArea" className="block text-gray-500 text-sm mb-2">
              ...
              <div className="relative">
                <Input
                  ...
                  aria-required="true"
                  aria-invalid={!!errors.workingArea}
                  aria-describedby={errors.workingArea ? "workingArea-error workingArea-help" : "workingArea-help"}
                  autoComplete="off"
                />
                {showSuggestions && activeField === "workingArea" && locationSuggestions.length > 0 && (
                  <div className="absolute z-10 w-full mt-2 bg-white border border-gray-200 rounded-2xl shadow-lg max-h-60 overflow-y-auto" role="listbox">
              ...
              {errors.workingArea && (
                <p id="workingArea-error" className="text-red-500 text-sm mt-1" role="alert">{errors.workingArea}</p>
              )}
              <p id="workingArea-help" className="text-gray-400 text-xs mt-1">
          ...
          {formData.mechanicType === "shop" && (
            <div className="space-y-6 pt-4 border-t border-gray-200">
              ...
              {/* Shop Name */}
              <div>
                <label htmlFor="shopName" className="block text-gray-500 text-sm mb-2">
                ...
                />
                {errors.shopName && (
                  <p id="shopName-error" className="text-red-500 text-sm mt-1" role="alert">{errors.shopName}</p>
                )}
              </div>

              {/* Shop Location */}
              <div>
                <label htmlFor="shopLocation" className="block text-gray-500 text-sm mb-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    aria-describedby={errors.shopLocation ? "shopLocation-error" : undefined}
                    autoComplete="off"
                  />
                ...
                {errors.shopLocation && (
                  <p id="shopLocation-error" className="text-red-500 text-sm mt-1" role="alert">{errors.shopLocation}</p>
                )}
              </div>

              {/* Shop Address */}
              <div>
                <label htmlFor="shopAddress" className="block text-gray-500 text-sm mb-2">
                ...
                <Textarea
                  ...
                  aria-describedby={errors.shopAddress ? "shopAddress-error" : undefined}
                />
                {errors.shopAddress && (
                  <p id="shopAddress-error" className="text-red-500 text-sm mt-1" role="alert">{errors.shopAddress}</p>
                )}
              </div>
            </div>
          )}
          ...
          <Button
            ...
            aria-label={isSubmitting ? "Submitting application" : "Submit mechanic application"}
          >
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex justify-center pt-4">
            <Button
              ...
              aria-label="Close error dialog and try again"
            >
              Try Again
            </Button>
          </div>
